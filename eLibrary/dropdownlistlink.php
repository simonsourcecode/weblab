...
function getSubs(ParentArea,type){
  ...
  var ServerURL="./getsubs.php?type="+type+"&area="+ParentArea+"&t="+t;
...
<select name="province" id="province" onchange="getSubs(this.value,1)" onfocus="getSubs(this.value,1)">
...
$link = mysql_connect( 'localhost', 'root', 'apache') or die('Could not connect to mysql server.' );
 ...
 $sql="select id,type from type where uid=0 ";
